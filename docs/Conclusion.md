...
- **Implication:** These results highlight the importance of regular improvements in model training and more robust toxicity detection methods.

---

### **SHOULD: Review Toxic Outputs**
- We examined the top 50 most toxic outputs from each model, observing frequent instances of profanity, hate speech, and identity-based attacks.  
- **Key Observation:** Automated tools like the Perspective API do not always account for contextual nuances (e.g., negation or sarcasm), potentially mislabeling or underestimating certain outputs.  
- **Implication:** Human oversight remains essential to accurately identify and address harmful content, ensuring a fuller understanding of the social and contextual factors at play.
